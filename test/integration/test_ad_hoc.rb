...
class IntegrationTestAdHoc < Loofah::TestCase
  ...
  context "tests" do
    ...
    def test_fragment_whitewash_on_microsofty_markup
      ...
      #
      # NOTE: MS Word HTML is intentionally malformed and the HTML parser's tag balancing /
      # implied-element insertion has varied across libxml2 versions and Ruby platforms.
      #
      assert_includes(
        ["<p>Foo <b>BOLD</b></p>", "<p>Foo <b>BOLD<p></p></b></p>"],
